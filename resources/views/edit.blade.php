...
<head>
    <title>Ubah Jadwal Kuliah</title>
    <meta charset="utf-8">
    ...
    <div class="container">
        ...
        <form action="{{ url('/edit/' . $data->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="jam" class="form-control" id="jam" name="jam" value="{{ $data->jam }}">
            </div>
            <div class="form-group">
